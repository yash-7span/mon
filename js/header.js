...
<div class="header-container">
    ...
    <div class="location-dropdown">
         <div class="loc-dropdown-inner">
              <img src="./images/rl-vector.svg" alt="">
              <div class="btn-group">
...
<header class="head">
    <nav class="navbar navbar-expand-lg">
         <div class="navbar-logo position-relative">
              <a class="navbar-brand"><img src="./images/logo-svg.svg" class="img-fluid logo-img"
                        alt=""><img src="./images/logo-mobile.svg" class="img-fluid logo-img device" alt=""></a>
