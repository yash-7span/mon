          ...
          <div class="footer-main container-fluid">
               <div class="row fd-row">
                    <div class="col-xxl-3 col-xl-4 col-lg-5 col-md-5 col-mb one">
                         ...
                         <?php 
                              $footer_logo = get_field('footer_logo', 'option'); // Get ACF image field from options page
                              $footer_logo_url = is_array($footer_logo) ? $footer_logo['url'] : $footer_logo; // Ensure URL format
                         ?>
                              <a href="https://mrs-socialcup-website.pages.dev">
                              <img src="<?php echo esc_url($footer_logo_url); ?>" alt="Footer Logo" class="img-fluid d-inline-block">
                              <p class="text-title d-inline-block ms-2">Strength of the Stallion</p>
                              </a>
               ...
               <div class="row mr-top">
                    <div class="col-lg-12">
                         <div class="copy_rights border-t">
                              ...
                              <div class="crafted">
                                   <img src="http://localhost/mod/wp-content/uploads/2025/03/footer_sandcup.png" alt="" class="img-fluid">
