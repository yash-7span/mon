            ...
            <div class="accordion" id="RetailStation">
                ...
                <div class="accordion-item">
                    <div class="accordion-header">
                        <div class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#location_two">
                            <div class="row width_rt">
                                <div class="col-md-1">
                                    <div class="loc-number">
                        ...
                        <div class="accordion-collapse collapse" data-bs-parent="#RetailStation" id="location_two">
                            <div class="accordion-body row">
                                <div class="col-md-1">
                                </div>
                                <div class="col-md-11">
                ...
                <div class="accordion-item">
                    <div class="accordion-header">
                        <div class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#location_three">
                            <div class="row width_rt">
                                <div class="col-md-1">
                                    <div class="loc-number">
                                ...
                                <div class="col-md-11">
                                    <div class="loc-content">
                                        <div class="loc-title">
                                            <h4 class="loc-name">MRS TANKE ROAD</h4>
                                            <span class="red-text loc-side">South</span>
                                        </div>
                                        <h5 class="mb-0 grey-text">KM 2 TANKE GRA UNIVERSITY ROAD, KWARA, ILORIN.</h5>
                                    </div>
                        ...
                        <div class="accordion-collapse collapse" data-bs-parent="#RetailStation" id="location_three">
                            <div class="accordion-body row">
                                <div class="col-md-1">
                                </div>
                                <div class="col-md-11">
                ...
                <div class="accordion-item">
                    <div class="accordion-header">
                        <div class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#location_four">
                            <div class="row width_rt">
                                <div class="col-md-1">
                                    <div class="loc-number">
                        ...
                        <div class="accordion-collapse collapse" data-bs-parent="#RetailStation" id="location_four">
                            <div class="accordion-body row">
                                <div class="col-md-1">
                                </div>
                                <div class="col-md-11">
