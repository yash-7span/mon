...
?>
    <img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/blocks/investor-relations-list/investor-relations-img.png'); ?>" alt="Preview" style="width: 100%; height: auto;">
<?php
    return;
endif;
