...
<div class="our-locations" id="RedirectLocation">
     <div class="aboutus-title text-center" id="RedirectAtrr">
          ...
          <p class="mb-0 center-disc">
            <?php echo $description;?>
          </p>
     </div>
     <div class="location-boxes position-relative">
          <div class="financial-tabs nav nav-tabs redirectTabs">
               <a class="nav-link active" data-bs-toggle="tab" data-bs-target="#tabDepot" type="button" role="tab">
                    <h5 class="mb-0 fw-bold">Depot</h5>
               </a>
               <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tabWarehouse" type="button" role="tab">
                    <h5 class="mb-0 fw-bold">Warehouse</h5>
               </a>
          </div>   

          <div class="tab-content general-items">
               <div class="tab-pane fade show active" id="tabDepot" role="tabpanel">
                    ...
                    <?php 
                        while( have_rows('locations') ) : 
                            ...
                            $location_type = get_sub_field('location_type'); // Assuming you have a field to define the type (Depot or Warehouse)
                            if($location_type == 'depot'){ 
                                ?>
                                <div class="col-md-4 width_30">
                                    <div class="inner-lbox">
                                        <a href="<?php echo $location_map_url;?>" class="title-lbox" target="_blank">
                                                <h5 class="fw-bold mb-0 hover_title"><?php echo $office_name;?></h5>
                                        ...
                                        <div class="details-lbox">
                                                <a href="https://maps.app.goo.gl/ok1jQtnVrUPHuuPy8" class="items-lbox" target="_blank">
                                                    ...
                                                    <p class="mb-0 hover_p"><?php echo $address;?></p>
                                                </a>

                                                <a href="mailto:<?php echo $email;?>" class="items-lbox">
                                                    ...
                                                    <p class="mb-0 hover_p"><?php echo $email;?></p>
                                                </a>
                                                <a href="tel:+<?php echo $telephone;?>" class="items-lbox">
                                                    ...
                                                    <p class="mb-0 hover_p">+<?php echo $telephone;?></p>
                                                </a>
               ...
               <div class="tab-pane fade" id="tabWarehouse" role="tabpanel">
                    <div class="row row_lc">
                    <?php 
                        while( have_rows('locations') ) : 
                            the_row(); 
