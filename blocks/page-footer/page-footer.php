...
$contact_number = $social_contact['contact_number'];
$fax_number = $social_contact['fax_number'];
...
$copyright_title = $copyright['copyright_title'];
    ...
    <div class="col-lg-12">
        <div class="copy_rights border-t">
            ...
            <div class="crafted">
                ...
                <p class="fd-text mb-0">Crafted by <a href="<?php echo $company_address_url;?>" class="fd-text" target="<?php echo $company_address_target;?>"><?php echo $company_address_title;?></a></p>
                <?php endif;?>
            </div>
        </div>
    </div>
